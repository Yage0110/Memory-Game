...
MemoryGame(string *words, int size, int numSlots); //instead of randomly generated integers,
//use words as data
~MemoryGame();
void play();
void display() const;
...
//input an int that is a valid index and
       ...
       //bShown[i] is false.
private: //private data members, private means that //only methods in this class, not other class,
